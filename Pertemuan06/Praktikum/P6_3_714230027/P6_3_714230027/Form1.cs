...
namespace P6_3_714230027
{
    public partial class Form1 : Form
    {
        ...
        private void textAngka_TextChanged(object sender, EventArgs e)
        {
            if (textAngka.Text == "")
            {
                SetErrorMessages(textAngka, "Textbox Angka tidak boleh kosong!", "", "");
            }
            else if (textAngka.Text.All(Char.IsNumber))
            {
                SetErrorMessages(textAngka, "", "", "Betul!");
            }
            else
            {
                SetErrorMessages(textAngka, "", "Inputan hanya boleh angka!", "");
            }
        }
